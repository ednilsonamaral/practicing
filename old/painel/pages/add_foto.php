...
<div id="geral">
	<div class="localizacao">
		Você está em: 
			<strong>
				<em>
					ADMINISTRAÇÃO DAS GALERIAS DE FOTOS » CADASTRO DE UMA NOVA FOTO NA GALERIA DE FOTO <?php echo $nome_galeria; ?>
				</em>
			</strong>
	</div><!-- FIM DO BLOCO DA LOCALIZAÇÃO DO USUÁRIO -->
	
	<div class="quadro_login">
		<p class="titulo">Cadastrando uma Nova Foto na Galeria de Foto <?php echo $nome_galeria; ?></p>
		
		<form name="frm" id="frm" method="post" action="confirma_add_foto.php" enctype="multipart/form-data">
			...
			<table>
				...
				<tr>
					...
					<td style="padding: 10px; width: 450px;">
						<input type="text" name="legenda" size="50" required placeholder="digite aqui a legenda da foto" maxlength="100" style="text-transform: uppercase;" />
					</td>
				</tr>
