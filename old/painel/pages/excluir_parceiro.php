...
<div id="geral">
	...
	<div class="quadro_login">
		...
		<section id="quadro_data_table">
			...
			$esql = "SELECT * FROM parceiros WHERE id='$id_parceiro'";
			$equery = mysql_query($esql);
			
			while( $elinha = mysql_fetch_object($equery) ){
				$nome_parceiro = $elinha->nome_parceiro;
				$logo = $elinha->logo;
			}
			?>
			
			<p>
				Você tem certeza que deseja EXCLUIR o Parceiro <strong><?php echo $nome_parceiro; ?></strong> do GoPanel?
			</p>
			
			<div class="bloco_exclui_usuario" align="center">
				<a href="confirma_exclui_parceiro.php?id_parceiro=<?php echo $id_parceiro; ?>&id_usuario_cadastro=<?php echo $id_usuario; ?>&logo=<?php echo $logo; ?>" alt="CONFIRMAR E EXCLUIR PARCEIRO DO GOPANEL" title="CONFIRMAR E EXCLUIR PARCEIRO DO GOPANEL" style="text-decoration: none;">
					<img src="../img/confirmar.png" style="width: 24px; height: 24px;" alt="CONFIRMAR E EXCLUIR PARCEIRO DO GOPANEL" title="CONFIRMAR E EXCLUIR PARCEIRO DO GOPANEL" />
				</a>
