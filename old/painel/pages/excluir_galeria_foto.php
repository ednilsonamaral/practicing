...
<div id="geral">
	<div class="localizacao">
		Você está em: 
			<strong>
				<em>
					ADMINISTRAÇÃO DAS GALERIAS DE FOTOS » EXCLUIR GALERIA DE FOTOS
				</em>
			</strong>
	</div><!-- FIM DO BLOCO DA LOCALIZAÇÃO DO USUÁRIO -->
	
	<div class="quadro_login">
		<p class="titulo">Excluindo Galeria de Fotos do GoPanel</p>
		...
		<section id="quadro_data_table">
			...
			<p>
				Você tem certeza que deseja EXCLUIR a GALERIA DE FOTOS <strong><?php echo $nome_galeria; ?></strong> do GoPanel?
			</p>
			
			<div class="bloco_exclui_usuario" align="center">
				<a href="confirma_excluir_galeria_foto.php?id_galeria_foto=<?php echo $id_galeria_foto; ?>&id_usuario_cadastro=<?php echo $id_usuario; ?>" alt="CONFIRMAR E EXCLUIR GALERIA DE FOTOS" title="CONFIRMAR E EXCLUIR GALERIA DE FOTOS" style="text-decoration: none;">
					<img src="../img/confirmar.png" style="width: 24px; height: 24px;" alt="CONFIRMAR E EXCLUIR GALERIA DE FOTOS" title="CONFIRMAR E EXCLUIR GALERIA DE FOTOS" />
				</a>
