...
<div id="geral">
	<div class="localizacao">
		...
		$psql = "SELECT * FROM produtos WHERE id='$id_produto'";
		$pquery = mysql_query($psql);
		
		while( $plinha = mysql_fetch_object($pquery) ){
			$nome_produto = $plinha->nome_produto;
		...
		?>
			...
			<strong>
				<em>
					ADMINISTRAÇÃO DA PÁGINA DO PRODUTO <?php echo $nome_produto; ?>
				</em>
			</strong>
	</div><!-- FIM DO BLOCO DA LOCALIZAÇÃO DO USUÁRIO -->
	
	<div class="conteudo">
		<form name="form" method="post" action="confirma_edita_produto.php">
