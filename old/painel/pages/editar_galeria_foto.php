...
<div id="geral">
	<div class="localizacao">
		Você está em: 
			<strong>
				<em>
					ADMINISTRAÇÃO DAS GALERIAS DE FOTOS » EDITANDO OS DADOS BÁSICOS DA GALERIA DE FOTO <?php echo $nome_galeria; ?>
				</em>
			</strong>
	</div><!-- FIM DO BLOCO DA LOCALIZAÇÃO DO USUÁRIO -->
	
	<div class="quadro_login">
		<p class="titulo">Editando os Dados Básicos da Galeria de Foto <?php echo $nome_galeria; ?></p>
		
		<form name="frm" id="frm" method="post" action="confirma_editar_galeria_foto.php">
			...
			<table>
				<tr>
					...
					<td style="padding: 10px; width: 450px;">
						<input type="text" size="50" maxlength="100" value="<?php echo $nome_galeria; ?>" style="text-transform: uppercase;" name="nome_galeria" />
					</td>
				</tr>
