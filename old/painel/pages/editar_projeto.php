...
<div id="geral">
	<div class="localizacao">
		...
		$psql = "SELECT * FROM projetos WHERE id='$id_projeto'";
		$pquery = mysql_query($psql);
		
		while( $plinha = mysql_fetch_object($pquery) ){
			$nome_projeto = $plinha->nome_projeto;
		...
		?>
			...
			<strong>
				<em>
					ADMINISTRAÇÃO DA PÁGINA DO PROJETO <?php echo $nome_projeto; ?>
				</em>
			</strong>
	</div><!-- FIM DO BLOCO DA LOCALIZAÇÃO DO USUÁRIO -->
	
	<div class="conteudo">
		<form name="form" method="post" action="confirma_edita_projeto.php">
